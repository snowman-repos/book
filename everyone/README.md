...
It can of course be quite overwhelming. You need to manage your time and resources in a way that you benefit from the learning material in a tangible way. An article about a new JavaScript library may be very interesting, but unless you're going to put it into practice and commit it to memory then your time may be better spent reading something else. Some things are not even worth learning because they can be so easily referenced. Obscure CSS hacks for instance. On the rare occasion that you run into a problem that can be easily fixed with 30 seconds on a search engine, then why waste precious time committing it to memory? Thomas Edison once devised a questionnaire to asses the usefulness of potential new employees. He wanted to be able to identify people who could memorise a great deal of information and would be able to make quick business decisions. Known as 'The Wizard of Menlo Park', Edison was widely regarded as a genius. Yet when Albert Einstein arrived in the United States in 1921, he sensed competition, even accusing Einstein's work of having no practical value. On the 17th of May that year, on a visit to Boston, Einstein was challenged with completing Edison's questionnaire. The Wizard must have been delighted when the New York Times reported that Einstein failed the test, not even able to answer the question 'What is the speed of sound?'. Why memorise such facts, Einstein remarked, when one could easily look them up in a textbook?
