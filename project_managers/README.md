...
You may have noticed that this chapter is considerably longer than the others. While that may not be surprising for a chapter about project management in a book that's primarily about project management, but it doesn't mean that the web project manager's workload is the weightiests or his tasks the most complex. You do, however, have the greatest number of responsibiities and different hats to wear. You are involved with everybody at every stage and so many approaches you can take.
