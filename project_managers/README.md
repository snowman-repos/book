...
You may have noticed that this chapter is considerably longer than the others. While that may not be surprising for a chapter about project management in a book that's primarily about project management, it doesn't mean that the web project manager's workload is the weightiest or his tasks the most complex. You do, however, have the greatest number of responsibilities and different hats to wear. You are involved with everybody at every stage and so there are many approaches you can take.
