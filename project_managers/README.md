...
Essentially how it works is everyone has a local code repository on their computer on which they run their own changes. You have the option of having a remote repository on a private server, or on a service like Github. Git will determine how the changes fit together and synchronise everyone's work.
